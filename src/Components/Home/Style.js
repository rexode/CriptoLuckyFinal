...
fontFamily:"Inter-Regular", 
        ...
        '& .getstarted':{
            ...
            width:"210px",
            height:"58px",
            background:"linear-gradient(95.71deg, rgba(218, 16, 255, 0.71) -0.06%, rgba(0, 26, 255, 0.71) 113.1%)",
            borderRadius:"29px",
    ...
    background: "linear-gradient(175.11deg, rgba(218, 16, 255, 0.08) 11%, rgba(0, 26, 255, 0.11) 96.99%)",
